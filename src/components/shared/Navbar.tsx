...
import { MessageSquareText, Settings, Database, Search, BrainCircuit, Sparkles } from 'lucide-react';
...
export function Navbar() {
  ...
  const navItems = [
    { href: '/', label: 'Dashboard', icon: Sparkles }, // Changed Chat to Dashboard
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-1 flex justify-center px-8 lg:px-16">
            <div className="relative w-full max-w-md">
              <Input
                type="search"
                placeholder="Search catalog, ask questions..."
